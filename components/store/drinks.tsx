import {
  ...
  const StoreContainer = ({ navigation}) => {
    ...
    const DrinksItems = () => {
        let DrinksData =  menuData.slice(26, 40)
     const renderStoreItems = ({ item }) => {
      ...
      let description = item.ingredients
  
        return (
          <View>
           <TouchableOpacity onPress={() => navigation.navigate('Store-Product', { key, name, price, image, carousel, description})}>
